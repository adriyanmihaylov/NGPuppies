...
//
//        List<Subscriber> subscribers = subscriberService.getAllSubscribersUsingServiceByServiceName(VALID_TELECOMSERV_ID);
//
...
//        when(subscribersRepository.getTenAllTimeSubscribersOfClientWithBiggestBillsPaid(VALID_CLIENT_ID)).thenReturn(subscriberList);
//
//        List<Subscriber> subscribers = subscriberService.getTenAllTimeSubscribersOfClientWithBiggestBillsPaid(VALID_CLIENT_ID);
//
//        Assert.assertEquals(subscribers.get(0), subscriberList.get(0));
//    }
//
...
//        when(subscribersRepository.getTenAllTimeSubscribersOfClientWithBiggestBillsPaid(VALID_CLIENT_ID)).thenReturn(new ArrayList<>());
//
//        List<Subscriber> subscribers = subscriberService.getTenAllTimeSubscribersOfClientWithBiggestBillsPaid(VALID_CLIENT_ID);
//
